...
#include "dbm_params_alternating_binary.hpp"
...
int main() {
    ...
    OptionsWakeSleep_RBM_CD_AB options_wake_sleep;
    ...
    int no_cd_steps = 5;
    double dt = 0.01;
    int no_steps_move = 2; // 100

    std::string dir = "../data/learn_params_alternating_binary/";
